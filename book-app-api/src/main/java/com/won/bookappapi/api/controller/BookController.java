...
public class BookController {
    ...
    @GetMapping("/books")
    @Operation(summary = "책 검색 조회", description = "원하는 책의 키워드 검색 조회합니다.")
    public ResponseResult<List<BookDto>> searchBooks(@RequestParam @NotNull String keyword) {
    ...
    @PostMapping("/books")
    @Operation(summary = "책 저장", description = "저장된 책이 없는 경우 책을 저장합니다.")
